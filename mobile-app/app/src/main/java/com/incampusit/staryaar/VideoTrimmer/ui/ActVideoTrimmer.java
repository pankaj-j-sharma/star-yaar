package com.incampusit.staryaar.VideoTrimmer.ui;
...
import com.incampusit.staryaar.VideoTrimmer.utils.LogMessage;
import com.incampusit.staryaar.VideoTrimmer.utils.TrimmerConstants;
import com.incampusit.staryaar.VideoTrimmer.utils.TrimmerUtils;
        ...
        try {
            ...
            if ((maxVal - minVal) <= maxToGap) {
                menuDone.getIcon().setColorFilter(
                        new PorterDuffColorFilter(ContextCompat.getColor(this, R.color.app_color_light)
                                , PorterDuff.Mode.SRC_IN)
                );
                isValidVideo = true;
            } else {
                menuDone.getIcon().setColorFilter(
                        new PorterDuffColorFilter(ContextCompat.getColor(this, R.color.app_color_lighter)
                                , PorterDuff.Mode.SRC_IN)
                );
                isValidVideo = false;
            }
