...
import com.incampusit.staryaar.SegmentProgress.ProgressBarListener;
import com.incampusit.staryaar.SegmentProgress.SegmentedProgressBar;
...
public class Video_Recoder_A extends AppCompatActivity implements View.OnClickListener {
    ...
    public void Merge_withAudio() {
        ...
        Log.d(Variables.TAG, "Merge With Audio started");
    ...
    public void Go_To_preview_Activity() {
        Log.d(Variables.TAG, "Go To Preview Video started");
        Intent intent = new Intent(this, Preview_Video_A.class);
        Preview_Video_A.isFiltered = false;
