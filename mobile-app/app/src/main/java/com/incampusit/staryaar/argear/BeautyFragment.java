...
public class BeautyFragment
    ...
    private SeekBar.OnSeekBarChangeListener BeautySeekBarListener = new SeekBar.OnSeekBarChangeListener() {
        ...
        public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
            if (fromUser) {
                ...
                ((ArGearCameraActivity) getActivity()).setBeauty(mBeautyItemData.getBeautyValues());
            }
        }
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        mBeautyItemData = ((ArGearCameraActivity) getActivity()).getBeautyItemData();
    ...
    public void onClick(View v) {
        ...
        switch (v.getId()) {
            case R.id.beauty_init_button:
                ((ArGearCameraActivity) getActivity()).setBeauty(AppConfig.BEAUTY_TYPE_INIT_VALUE);
    ...
    private void zeroBeautyParam() {
        ((ArGearCameraActivity) getActivity()).setBeauty(new float[ARGContents.BEAUTY_TYPE_NUM]);
    }
