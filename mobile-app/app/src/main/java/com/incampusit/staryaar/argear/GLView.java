...
public class GLView extends GLSurfaceView implements GLSurfaceView.Renderer {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        int glviewWidth = ((ArGearCameraActivity) getContext()).getGLViewWidth();
        int glviewHeight = ((ArGearCameraActivity) getContext()).getGLViewHeight();
        ...
        if (glviewWidth > 0 && glviewHeight > 0) {
            ...
            ((ArGearCameraActivity) getContext()).setMeasureSurfaceView(this);
        } else {
