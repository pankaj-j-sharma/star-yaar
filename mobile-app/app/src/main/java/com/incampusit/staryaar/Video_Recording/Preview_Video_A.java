...
import com.incampusit.staryaar.Filter.FilterType;
import com.incampusit.staryaar.Filter.Filter_Adapter;
...
public class Preview_Video_A extends AppCompatActivity implements Player.EventListener {
    ...
    public void Save_Video(String srcMp4Path, final String destMp4Path) {
        ...
        Log.d(Variables.TAG, "Save_Video srcMp4Path " + srcMp4Path + " destMp4Path" + destMp4Path);

        new GPUMp4Composer(srcMp4Path, destMp4Path)
                //.size(540, 960)
                .videoBitrate(Variables.fixed_bitrate)
                .mute(false)
                    ...
                    public void onCompleted() {
                        ...
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                ...
                                if (isFiltered) {
                                    Log.d(Variables.TAG, "is filterted video " + isFiltered);
                                    Merge_Audio_Video_Filtered();
                                } else {
                                    Log.d(Variables.TAG, "is not filterted video");
                                    GotopostScreen();
                                }
    ...
    private void Merge_Audio_Video_Filtered() {
        ...
        String video = Variables.output_filter_file;
        String finaloutput = Variables.output_filter_file_tmp;

        Merge_Video_Audio_Filtered merge_video_audio_filtered = new Merge_Video_Audio_Filtered(Preview_Video_A.this);
        merge_video_audio_filtered.doInBackground(audio_file, video, finaloutput);
    }
    ...
    public void GotopostScreen() {
        ...
        intent.putExtra("outputFilePath", Variables.output_filter_file);
