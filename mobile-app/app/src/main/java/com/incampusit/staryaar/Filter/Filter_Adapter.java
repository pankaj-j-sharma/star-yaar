...
public class Filter_Adapter extends RecyclerView.Adapter<Filter_Adapter.CustomViewHolder> {
    ...
    public void onBindViewHolder(final Filter_Adapter.CustomViewHolder holder, final int i) {
        ...
        holder.fiter_txt.setText(datalist.get(i).toString());
        holder.fiter_txt.setTextSize(10);

        if (Preview_Video_A.select_postion == i) {
            holder.ivPhoto.setBackground(holder.itemView.getContext().getDrawable(R.drawable.camera_filter_background_selected));
            holder.ivPhoto.setPadding(20, 20, 20, 20);
            holder.ivPhoto.setElevation(20);
            holder.fiter_txt.setTextColor(holder.itemView.getContext().getColor(R.color.app_color_dark));
        } else {
            holder.ivPhoto.setBackground(holder.itemView.getContext().getDrawable(R.drawable.camera_filter_background));
            holder.ivPhoto.setPadding(0, 0, 0, 0);
            holder.ivPhoto.setElevation(0);
            holder.fiter_txt.setTextColor(holder.itemView.getContext().getColor(R.color.graycolor));
        }

        /*
        if (Preview_Video_A.select_postion == i) {
            holder.ivPhoto.setBackgroundColor(context.getResources().getColor(R.color.app_color));
        }
         */
